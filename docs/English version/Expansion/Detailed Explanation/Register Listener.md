...
EnderDragon expansion provides a simplified method to register a listener.
...
The above code implements the monitoring of player joining server events and player exiting server events, and outputs some information.
